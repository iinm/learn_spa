...
spa.shell = (function () {
  ...
  // Returns stored anchor map; minimize overhead
  ...
  //     we want changed.
  // Returns   : boolean
  //   * true  - the anchor portion of URI was update
  //   * false - the anchor portion of URI could not be updated
  // Action    :
